...
1. Upload `ul-title.php` to `wp-content/plugins/` directory. Optionally, you can create a folder called `ul-title` and place `ul-title` within this folder.
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Place `<?php wp_ul_title ( $params ); ?>` in your template file
